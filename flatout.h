...
namespace
{
	...
	void flatout_book(TDirectory* olddir)
	{
		...
		addBranch("met_reffinal_et_uncalib",      order, FLT);
		addBranch("met_reffinal_phi_uncalib",     order, FLT);
		addBranch("met_reffinal_mT_uncalib",      order, VFLT);
		addBranch("met_reffinal_dPhi3mu_uncalib", order, VFLT);
		...
		addBranch("met_reffinal_et_jes_up",        order, FLT);
		addBranch("met_reffinal_phi_jes_up",       order, FLT);
		addBranch("met_reffinal_mT_jes_up",        order, VFLT);
		addBranch("met_reffinal_dPhi3mu_jes_up",   order, VFLT);
		addBranch("met_reffinal_et_jes_dwn",      order, FLT);
		addBranch("met_reffinal_phi_jes_dwn",     order, FLT);
		addBranch("met_reffinal_mT_jes_dwn",      order, VFLT);
		addBranch("met_reffinal_dPhi3mu_jes_dwn", order, VFLT);

		addBranch("met_reffinal_et_jer_up",        order, FLT);
		addBranch("met_reffinal_phi_jer_up",       order, FLT);
		addBranch("met_reffinal_mT_jer_up",        order, VFLT);
		addBranch("met_reffinal_dPhi3mu_jer_up",   order, VFLT);
		addBranch("met_reffinal_et_jer_dwn",      order, FLT);
		addBranch("met_reffinal_phi_jer_dwn",     order, FLT);
		addBranch("met_reffinal_mT_jer_dwn",      order, VFLT);
		addBranch("met_reffinal_dPhi3mu_jer_dwn", order, VFLT);


		// MET_Muons-based kinematics
		addBranch("met_muons_et_uncalib",      order, FLT);
		addBranch("met_muons_phi_uncalib",     order, FLT);
		addBranch("met_muons_mT_uncalib",      order, VFLT);
		addBranch("met_muons_dPhi3mu_uncalib", order, VFLT);
		...
		addBranch("met_muons_et_jes_up",        order, FLT);
		addBranch("met_muons_phi_jes_up",       order, FLT);
		addBranch("met_muons_mT_jes_up",        order, VFLT);
		addBranch("met_muons_dPhi3mu_jes_up",   order, VFLT);
		addBranch("met_muons_et_jes_dwn",      order, FLT);
		addBranch("met_muons_phi_jes_dwn",     order, FLT);
		addBranch("met_muons_mT_jes_dwn",      order, VFLT);
		addBranch("met_muons_dPhi3mu_jes_dwn", order, VFLT);

		addBranch("met_muons_et_jer_up",        order, FLT);
		addBranch("met_muons_phi_jer_up",       order, FLT);
		addBranch("met_muons_mT_jer_up",        order, VFLT);
		addBranch("met_muons_dPhi3mu_jer_up",   order, VFLT);
		addBranch("met_muons_et_jer_dwn",      order, FLT);
		...
		// Jets
		addBranch("jet_pt1_uncalib", order, VFLT);
		addBranch("jet_pt2_uncalib", order, VFLT);
		addBranch("jet_pt3_uncalib", order, VFLT);
		addBranch("jet_pt4_uncalib", order, VFLT);
		addBranch("jet_pt1",       order, VFLT);
		addBranch("jet_pt2",       order, VFLT);
		addBranch("jet_pt3",       order, VFLT);
		addBranch("jet_pt4",       order, VFLT);
		addBranch("jet_pt1_jes_up", order, VFLT);
		addBranch("jet_pt2_jes_up", order, VFLT);
		addBranch("jet_pt3_jes_up", order, VFLT);
		addBranch("jet_pt4_jes_up", order, VFLT);
		addBranch("jet_pt1_jes_dwn", order, VFLT);
		addBranch("jet_pt2_jes_dwn", order, VFLT);
		addBranch("jet_pt3_jes_dwn", order, VFLT);
		addBranch("jet_pt4_jes_dwn", order, VFLT);
		addBranch("jet_pt1_jer_up", order, VFLT);
		addBranch("jet_pt2_jer_up", order, VFLT);
		addBranch("jet_pt3_jer_up", order, VFLT);
		addBranch("jet_pt4_jer_up", order, VFLT);
		addBranch("jet_pt1_jer_dwn", order, VFLT);
		addBranch("jet_pt2_jer_dwn", order, VFLT);
		addBranch("jet_pt3_jer_dwn", order, VFLT);
		addBranch("jet_pt4_jer_dwn", order, VFLT);
		
		addBranch("jet_E1_uncalib", order, VFLT);
		addBranch("jet_E2_uncalib", order, VFLT);
		addBranch("jet_E3_uncalib", order, VFLT);
		addBranch("jet_E4_uncalib", order, VFLT);
		addBranch("jet_E1",       order, VFLT);
		addBranch("jet_E2",       order, VFLT);
		addBranch("jet_E3",       order, VFLT);
		addBranch("jet_E4",       order, VFLT);
		addBranch("jet_E1_jes_up", order, VFLT);
		addBranch("jet_E2_jes_up", order, VFLT);
		addBranch("jet_E3_jes_up", order, VFLT);
		addBranch("jet_E4_jes_up", order, VFLT);
		addBranch("jet_E1_jes_dwn", order, VFLT);
		addBranch("jet_E2_jes_dwn", order, VFLT);
		addBranch("jet_E3_jes_dwn", order, VFLT);
		addBranch("jet_E4_jes_dwn", order, VFLT);
		addBranch("jet_E1_jer_up", order, VFLT);
		addBranch("jet_E2_jer_up", order, VFLT);
		addBranch("jet_E3_jer_up", order, VFLT);
		addBranch("jet_E4_jer_up", order, VFLT);
		addBranch("jet_E1_jer_dwn", order, VFLT);
		addBranch("jet_E2_jer_dwn", order, VFLT);
		addBranch("jet_E3_jer_dwn", order, VFLT);
		addBranch("jet_E4_jer_dwn", order, VFLT);
		
		addBranch("jet_m1_uncalib", order, VFLT);
		addBranch("jet_m2_uncalib", order, VFLT);
		addBranch("jet_m3_uncalib", order, VFLT);
		addBranch("jet_m4_uncalib", order, VFLT);
		addBranch("jet_m1",       order, VFLT);
		addBranch("jet_m2",       order, VFLT);
		addBranch("jet_m3",       order, VFLT);
		addBranch("jet_m4",       order, VFLT);
		addBranch("jet_m1_jes_up", order, VFLT);
		addBranch("jet_m2_jes_up", order, VFLT);
		addBranch("jet_m3_jes_up", order, VFLT);
		addBranch("jet_m4_jes_up", order, VFLT);
		addBranch("jet_m1_jes_dwn", order, VFLT);
		addBranch("jet_m2_jes_dwn", order, VFLT);
		addBranch("jet_m3_jes_dwn", order, VFLT);
		addBranch("jet_m4_jes_dwn", order, VFLT);
		addBranch("jet_m1_jer_up", order, VFLT);
		addBranch("jet_m2_jer_up", order, VFLT);
		addBranch("jet_m3_jer_up", order, VFLT);
		addBranch("jet_m4_jer_up", order, VFLT);
		addBranch("jet_m1_jer_dwn", order, VFLT);
		addBranch("jet_m2_jer_dwn", order, VFLT);
		addBranch("jet_m3_jer_dwn", order, VFLT);
		addBranch("jet_m4_jer_dwn", order, VFLT);
		
		addBranch("jet_eta1_uncalib", order, VFLT);
		addBranch("jet_eta2_uncalib", order, VFLT);
		addBranch("jet_eta3_uncalib", order, VFLT);
		addBranch("jet_eta4_uncalib", order, VFLT);
		addBranch("jet_eta1",       order, VFLT);
		addBranch("jet_eta2",       order, VFLT);
		addBranch("jet_eta3",       order, VFLT);
		addBranch("jet_eta4",       order, VFLT);
		addBranch("jet_eta1_jes_up", order, VFLT);
		addBranch("jet_eta2_jes_up", order, VFLT);
		addBranch("jet_eta3_jes_up", order, VFLT);
		addBranch("jet_eta4_jes_up", order, VFLT);
		addBranch("jet_eta1_jes_dwn", order, VFLT);
		addBranch("jet_eta2_jes_dwn", order, VFLT);
		addBranch("jet_eta3_jes_dwn", order, VFLT);
		addBranch("jet_eta4_jes_dwn", order, VFLT);
		addBranch("jet_eta1_jer_up", order, VFLT);
		addBranch("jet_eta2_jer_up", order, VFLT);
		addBranch("jet_eta3_jer_up", order, VFLT);
		addBranch("jet_eta4_jer_up", order, VFLT);
		addBranch("jet_eta1_jer_dwn", order, VFLT);
		addBranch("jet_eta2_jer_dwn", order, VFLT);
		addBranch("jet_eta3_jer_dwn", order, VFLT);
		addBranch("jet_eta4_jer_dwn", order, VFLT);
		
		addBranch("jet_phi1_uncalib", order, VFLT);
		addBranch("jet_phi2_uncalib", order, VFLT);
		addBranch("jet_phi3_uncalib", order, VFLT);
		addBranch("jet_phi4_uncalib", order, VFLT);
		addBranch("jet_phi1",       order, VFLT);
		addBranch("jet_phi2",       order, VFLT);
		addBranch("jet_phi3",       order, VFLT);
		addBranch("jet_phi4",       order, VFLT);
		addBranch("jet_phi1_jes_up", order, VFLT);
		addBranch("jet_phi2_jes_up", order, VFLT);
		addBranch("jet_phi3_jes_up", order, VFLT);
		addBranch("jet_phi4_jes_up", order, VFLT);
		addBranch("jet_phi1_jes_dwn", order, VFLT);
		addBranch("jet_phi2_jes_dwn", order, VFLT);
		addBranch("jet_phi3_jes_dwn", order, VFLT);
		addBranch("jet_phi4_jes_dwn", order, VFLT);
		addBranch("jet_phi1_jer_up", order, VFLT);
		addBranch("jet_phi2_jer_up", order, VFLT);
		addBranch("jet_phi3_jer_up", order, VFLT);
		addBranch("jet_phi4_jer_up", order, VFLT);
		addBranch("jet_phi1_jer_dwn", order, VFLT);
		addBranch("jet_phi2_jer_dwn", order, VFLT);
		addBranch("jet_phi3_jer_dwn", order, VFLT);
		addBranch("jet_phi4_jer_dwn", order, VFLT);
		
		addBranch("jet_MV1w1_uncalib", order, VFLT);
		addBranch("jet_MV1w2_uncalib", order, VFLT);
		addBranch("jet_MV1w3_uncalib", order, VFLT);
		addBranch("jet_MV1w4_uncalib", order, VFLT);
		addBranch("jet_MV1w1",       order, VFLT);
		addBranch("jet_MV1w2",       order, VFLT);
		addBranch("jet_MV1w3",       order, VFLT);
		addBranch("jet_MV1w4",       order, VFLT);
		addBranch("jet_MV1w1_jes_up", order, VFLT);
		addBranch("jet_MV1w2_jes_up", order, VFLT);
		addBranch("jet_MV1w3_jes_up", order, VFLT);
		addBranch("jet_MV1w4_jes_up", order, VFLT);
		addBranch("jet_MV1w1_jes_dwn", order, VFLT);
		addBranch("jet_MV1w2_jes_dwn", order, VFLT);
		addBranch("jet_MV1w3_jes_dwn", order, VFLT);
		addBranch("jet_MV1w4_jes_dwn", order, VFLT);
		addBranch("jet_MV1w1_jer_up", order, VFLT);
		addBranch("jet_MV1w2_jer_up", order, VFLT);
		addBranch("jet_MV1w3_jer_up", order, VFLT);
		addBranch("jet_MV1w4_jer_up", order, VFLT);
		addBranch("jet_MV1w1_jer_dwn", order, VFLT);
		addBranch("jet_MV1w2_jer_dwn", order, VFLT);
		addBranch("jet_MV1w3_jer_dwn", order, VFLT);
		addBranch("jet_MV1w4_jer_dwn", order, VFLT);
		
		addBranch("jet_vtxf1_uncalib", order, VFLT);
		addBranch("jet_vtxf2_uncalib", order, VFLT);
		addBranch("jet_vtxf3_uncalib", order, VFLT);
		addBranch("jet_vtxf4_uncalib", order, VFLT);
		addBranch("jet_vtxf1",       order, VFLT);
		addBranch("jet_vtxf2",       order, VFLT);
		addBranch("jet_vtxf3",       order, VFLT);
		addBranch("jet_vtxf4",       order, VFLT);
		addBranch("jet_vtxf1_jes_up", order, VFLT);
		addBranch("jet_vtxf2_jes_up", order, VFLT);
		addBranch("jet_vtxf3_jes_up", order, VFLT);
		addBranch("jet_vtxf4_jes_up", order, VFLT);
		addBranch("jet_vtxf1_jes_dwn", order, VFLT);
		addBranch("jet_vtxf2_jes_dwn", order, VFLT);
		addBranch("jet_vtxf3_jes_dwn", order, VFLT);
		addBranch("jet_vtxf4_jes_dwn", order, VFLT);
		addBranch("jet_vtxf1_jer_up", order, VFLT);
		addBranch("jet_vtxf2_jer_up", order, VFLT);
		addBranch("jet_vtxf3_jer_up", order, VFLT);
		addBranch("jet_vtxf4_jer_up", order, VFLT);
		addBranch("jet_vtxf1_jer_dwn", order, VFLT);
		...
		addBranch("jet_sumpt12_uncalib",   order, VFLT);
		addBranch("jet_dphi3muJ1_uncalib", order, VFLT);
		addBranch("jet_dR3muJ1_uncalib",   order, VFLT);
		addBranch("jet_dphiJ1J2_uncalib",  order, VFLT);
		addBranch("jet_dRJ1J2_uncalib",    order, VFLT);
